...
|**Siyang Jiang** |**[@yang0731]** | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/1ceca617cea90246abb7c3b29968c005898c3620 | added a notification when created game session expires | A clear reminder of session expiration and for players to create a new session when the session expired |
|                 |                | 13.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/31aabe8780b1f3a8468969fb0792162c234a1451 (plus three follow-up commits for UI component parameter refinements, such as sizing adjustments)|updated menu page UI|As the menu page, the UI of this screen plays a critical role in shaping the player’s first impression of the game’s theme. A more engaging UI can significantly enhance the overall player experience.|
