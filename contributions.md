...
| **Student**        |**Github Username**| **Date** | **Link to Commit** | **Description**                 | **Relevance**                       |
| ------------------ | ------------------| -------- | ------------------ | ------------------------------- | ----------------------------------- |
|**Remy Klemenz** |**[@remy20cent]** | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/31eb7057083d9dff4e7f316be3d8f6dbc9a0f512 | Made user profile icons pixelated, changing them from emojis to sprites | Matches the overall old-school/pixelated style of the game |
|                 |                  | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/2af2e79459b0dab2b5ed4fe8d28d88f9b39f8e35 | Fixed a bug where the game statistics of player 2 were not saved in their user profile | Simple bug fix: statistics are now saved correctly for both player 1 and player 2 |
|                 |                  | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/10126bc5d239e226bc92a2552adf27fc3119e4a0 | Made simple CSS font changes for each page title to make them pixelated | Matches the overall old-school/pixelated style of the game |
|**Enrique Georg Zbinden** |**[@duracell04]** | 10.05.26 | https://github.com/duracell04/sopra-fs26-group-42-server/commit/605e99282965dd66457126e60eea706cc761152e | Fixed OpenRouter free-router feedback parsing and added focused `OpenRouterHttpClientTest` coverage for string, array, object, blank, missing-content, and non-2xx responses | Makes the external API integration more robust and increases meaningful backend test coverage for the final M4 submission |
|                          |                  | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/999e12bd0d133f44ad26561269e134f05943e867 | Improved authentication error handling and display by extracting clearer backend error messages, showing a specific invalid-login message for 401 responses, and replacing custom inline error markup with consistent Ant Design alerts | Improves usability and robustness of the login/register flow, supporting the final M4 usability requirement |
|**Siyang Jiang** |**[@yang0731]** | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/1ceca617cea90246abb7c3b29968c005898c3620 | Added a notification when a created game session expires | Provides a clear reminder when a session expires and informs players that they need to create a new session |
|                 |                | 13.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/31aabe8780b1f3a8468969fb0792162c234a1451 | Updated the menu page UI, including three follow-up commits for UI component parameter refinements such as sizing adjustments | The menu page plays a critical role in shaping the player’s first impression of the game’s theme. A more engaging UI improves the overall player experience |
|**Attila Vizhanyo** |**[@liroAV]** | 17.05.26 | https://github.com/duracell04/sopra-fs26-group-42-server/commit/72356d983cb4c80e7ac71257ba6687e7c0f969e8 | Fixed a critical security vulnerability by replacing plaintext password storage and comparison with BCrypt hashing. Passwords are now encoded on registration and checked with `matches()` on login. Added a `BCryptPasswordEncoder` bean and extended `UserServiceTest` with a dedicated hashing assertion | Passwords were previously stored in plaintext, meaning any database leak would expose all credentials directly. This hardens authentication to an industry-standard approach |
|                    |              | 17.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/d6b2a12 | Added a Jest test suite with 27 tests for the math problem generation utility, covering output structure, pair/block invariants, unique-solution guarantees, and normalization of both wire formats. Also wired up Jest and `ts-jest` with path alias support | The problem generator is the core game mechanic and previously had zero test coverage. A silent bug here could send players unsolvable or ambiguous problems without any visible error |
|**Csaba Vizhanyo** |**[@csaba_vi]** | 11.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/537853c3722200ffe121dc19b3276d7dc27b1350 | Improved the game level UI by redesigning the level screens and making the visual style more consistent with the pixelated/old-school theme of the game. The layout, styling, and overall presentation were adjusted to make the levels look cleaner, more polished, and more visually coherent | The level UI is central to the gameplay experience. A better design makes the game more enjoyable, easier to understand, and visually more professional. The stronger pixelated style also helps the whole game feel more consistent and immersive for players |

## Contributions Week 8 - 17.05.26 to 22.05.26

| **Student**        |**Github Username**| **Date** | **Link to Commit** | **Description**                 | **Relevance**                       |
| ------------------ | ------------------| -------- | ------------------ | ------------------------------- | ----------------------------------- |
|**Csaba Vizhanyo** |**[@csaba_vi]** | 22.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/22970f53f0e925f9cbdc8fe9edb06d0ff060f3d6 | Fixed session creation bug | Fixed a critical bug where the session would crash randomly after creation, making session handling stable and reliable |
|                   |                | 22.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/4b0f79dda56bf8d221e63811b5230d8ffbef19e0 | Redesigned the menu title | Finalizes the front end and makes the whole design work well together |
|                   |                | 22.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/01e1f5146d50f59a8b827810ab0ab53cc04cc1dd | Removed small text under the title | The text unnecessarily cluttered the design; removing it makes the front page look more appealing |
|                   |                | 22.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/b00d4d7b4eef7848765f31ecdb3cc80ac27078ae | Changed menu button colors and made the text pixelated | Finalizes the front end design and keeps it consistent with the old-school/pixelated theme |
|**Siyang Jiang** |**[@yang0731]** | 22.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/1f63271c363e0e50ceba7dacd1732f8ae64d5aec | Changed the error message design | Makes all error messages easily readable and gives them a consistent, unified design |
