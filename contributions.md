...
|                          |                  | 17.05.26 | https://github.com/duracell04/sopra-fs26-group-42-server/commit/f8159c2e93f4a029be57186514f3d387f955fba6 | Implemented OpenRouter-backed multiplication problem generation for game sessions with creator-only authorization, existing-problem reuse, deterministic fallback, JSON validation, and backend tests for valid generation, fallback paths, forbidden access, and unknown sessions. | Closes the S14 external API mismatch by making OpenRouter part of gameplay while preserving deterministic reliability for demos and production. |
|                          |                  | 17.05.26 | https://github.com/duracell04/sopra-fs26-group-42-client/commit/d8a2d2286da558030ba56a9a05c75b568ecade9a | Added structured OpenRouter summary feedback with schema-first prompts, feedback/tip output, fallback handling, shorter timeout/token settings, and frontend loading/summary display improvements. | Strengthens S16 by showing personalized end-game feedback and a next-round tip without making saved statistics depend on the external API. |
